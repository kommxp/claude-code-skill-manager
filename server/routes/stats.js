...
router.get('/heatmap', (req, res) => {
  // GitHub-style heatmap: daily stats for the past 365 days (GitHub 风格热力图：按天统计过去 365 天)
  const now = Date.now();
...
// GET /api/stats/translations — Translation cache stats (翻译缓存统计)
